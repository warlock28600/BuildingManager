...
using BuldingManager.Repo.ExpenseRepo;
...
namespace BuldingManager.Services.Expense
{
    public class ExpenseService : IExpenseService
    {
        ...
        {
            var expense = _mapper.Map<Entities.Expense>(expenseCreateDto);
        ...
        {
            return _expenseRepo.UpdateExpenseAsync(id, _mapper.Map<Entities.Expense>(expenceCreateDto));
        }
    }
}
