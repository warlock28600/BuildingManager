...
namespace BuldingManager.Migrations
{
    ...
    [Migration("20251031191309_expenceDataBaseChange")]
    partial class expenceDataBaseChange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuldingManager.Entities.Compounds", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BuldingManager.Entities.Expense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BuldingManager.Entities.FinancialPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BuldingManager.Entities.ResidentEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BuldingManager.Entities.BuildingEntity", b =>
                {
                    b.HasOne("BuldingManager.Entities.Compounds", "Compound")
                        .WithMany("Buildings")
            ...
            modelBuilder.Entity("BuldingManager.Entities.Expense", b =>
                {
                    b.HasOne("BuldingManager.Entities.Attribute", "Attribute")
                        .WithMany("Expenses")
                        .HasForeignKey("AttributeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BuldingManager.Entities.FinancialPeriod", "FinancialPeriod")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("BuldingManager.Entities.ResidentEntity", b =>
                {
                    ...
                    b.HasOne("BuldingManager.Entities.Persons", null)
                        .WithMany("Residents")
                        .HasForeignKey("PersonsId");

                    b.HasOne("BuldingManager.Entities.UnitEntity", null)
                        .WithMany("Residents")
